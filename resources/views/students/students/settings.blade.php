              ...
              @endif
                ...
                <h5 class="card-title">Course Information</h5>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{auth()->user()->course->course->course_department->faculty->name}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Department</div>
                    <div class="col-lg-9 col-md-8">{{auth()->user()->course->course->course_department->name}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Course</div>
                    <div class="col-lg-9 col-md-8">{{auth()->user()->course->course->name}}</div>
                  </div>
